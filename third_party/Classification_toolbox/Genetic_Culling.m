...
%	params  		- Algorithm parameters: [Fraction of groups in each chromosome, Output dimension , classifier type, classifier params]
%
% Outputs:
...
%
%See also Exhaustive_Feature_Selection, Sequential_Feature_Selection, Information_based_selection, RELIEF
%
%Example:
% load DHSchapter2
% [new_patterns, new_targets, pattern_numbers] = Genetic_Culling(patterns, targets, '[0.1, 2, ''LS'', []]');
