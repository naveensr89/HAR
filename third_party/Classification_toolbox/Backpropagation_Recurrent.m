...
%
%See also: Backpropagation_Batch, Backpropagation_CGD, Backpropagation_Quickprop, Backpropagation_SM, Backpropagation_Stochastic
%
%Example:
% load clouds
% t = Backpropagation_Recurrent(patterns, targets, patterns, [5, 0.1, 0.01]);
% disp(mean(t == targets))
