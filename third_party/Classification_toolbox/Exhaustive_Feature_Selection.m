...
%
%See also Sequential_Feature_Selection, Information_based_selection, RELIEF, Genetic_Culling
%
%Example:
% load DHSchapter2
% [new_patterns, new_targets, pattern_numbers] = Exhaustive_Feature_Selection(patterns, targets, '[2, ''LS'', []]');
