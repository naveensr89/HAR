...
%
%See also: Backpropagation_Batch, Backpropagation_CGD, Backpropagation_Quickprop, Backpropagation_Recurrent, Backpropagation_Stochastic
%
%Example:
% load clouds
% t = Backpropagation_SM(patterns, targets, patterns, [5, 0.1, 0.9, 0.1]);
% disp(mean(t == targets))
