function [patterns, targets, label] = LVQ1(train_patterns, train_targets, Nmu, plot_on)
...
%	targets			- New targets
%
%See also LVQ3, DSLVQ, k_means
%
%Example:
% load clouds
% [new_patterns, new_targets, labels] = LVQ1(patterns, targets, 10);
% disp(new_patterns)
