function [patterns, targets, label] = AGHC(train_patterns, train_targets, params, plot_on)
...
%	targets			- New targets
%
%See also k_means, ADDC, BIMSEC
%
%Example:
% load clouds
% [new_patterns, new_targets, labels] = AGHC(patterns, targets, '[10, ''min'']');
% disp(new_patterns)
