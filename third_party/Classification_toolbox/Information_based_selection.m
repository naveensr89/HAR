function [patterns, targets, remaining_patterns, discarded, gamma] = Information_based_selection(patterns, targets, Npatterns)
...
%
%See also Exhaustive_Feature_Selection, Sequential_Feature_Selection, RELIEF, Genetic_Culling
%
%Example:
% load DHSchapter2
% [new_patterns, new_targets, remaining_patterns] = Information_based_selection(patterns, targets, 2);
...
disp(['Last remaining pattern numbers: ' num2str(remaining_patterns)])
