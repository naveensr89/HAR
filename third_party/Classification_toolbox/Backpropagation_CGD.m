...
%
%See also: Backpropagation_Batch, Backpropagation_Quickprop, Backpropagation_Recurrent, Backpropagation_SM, Backpropagation_Stochastic
%
%Example:
% load clouds
% t = Backpropagation_CGD(patterns, targets, patterns, [5, 0.1]);
% disp(mean(t == targets))
