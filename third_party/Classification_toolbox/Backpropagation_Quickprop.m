...
%
%See also: Backpropagation_Batch, Backpropagation_CGD, Backpropagation_Recurrent, Backpropagation_SM, Backpropagation_Stochastic
%
%Example:
% load clouds
% t = Backpropagation_Quickprop(patterns, targets, patterns, [5, 0.1, 0.1, 2]);
% disp(mean(t == targets))
