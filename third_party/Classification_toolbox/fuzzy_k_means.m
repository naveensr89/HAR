function [patterns, targets, label] = fuzzy_k_means(train_patterns, train_targets, Nmu, plot_on)
...
%	targets			- New targets
%
%See also k_means, kernel_k_means, spectral_k_means
%
%Example:
% load clouds
% [new_patterns, new_targets, labels] = fuzzy_k_means(patterns, targets, 10);
% disp(new_patterns)
