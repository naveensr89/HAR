...
% Line commands
%
%       classification_system - Create a full classification system 
%
...
%		kernel_k_means			- Compute kernel k means for the data using the kernel version of the k_means algorithm
...
%		spectral_k_means		- Compute kernel k means for the data using the spectral version of the k_means algorithm
...
% Others
%
%       compute_kernel_matrix       - Compute a kernel matrix 
%
