...
%
%See also: Backpropagation_Batch, Backpropagation_CGD, Backpropagation_Quickprop, Backpropagation_Recurrent, Backpropagation_SM, Backpropagation_Stochastic
%
%Example:
% load clouds
% t = Optimal_Brain_Surgeon(patterns, targets, patterns, [10 .01]);
% disp(mean(t == targets))
