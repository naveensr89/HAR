...
%
%See also: Backpropagation_CGD, Backpropagation_Quickprop, Backpropagation_Recurrent, Backpropagation_SM, Backpropagation_Stochastic
%
%Example:
% load clouds
% t = Backpropagation_Batch(patterns, targets, patterns, [5, 0.1, 0.1]);
% disp(mean(t == targets))
