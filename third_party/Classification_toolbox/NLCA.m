function [new_patterns, targets] = NLCA(patterns, targets, params)
...
%	targets  - Targets
%
%See also ICA, MDS, MultipleDiscriminantAnalysis, HDR, PCA
%
%Example:
% load DHSchapter2
% [new_patterns, new_targets] = NLCA(patterns, targets, [2, 5]);
