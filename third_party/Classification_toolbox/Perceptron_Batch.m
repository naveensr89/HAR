...
%
%See also LS, Perceptron, Perceptron_BVI, Perceptron_FM, Perceptron_VIM, Perceptron_Batch, Perceptron_Voted
%
%Example:
% load clouds
% t = Perceptron_Batch(patterns, targets, patterns, [1000 0.01 0.01]);
% disp(mean(t == targets))
